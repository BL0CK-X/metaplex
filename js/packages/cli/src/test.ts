...
const rpcHost = 'https://d3j94ct3u36jen.cloudfront.net';
...
export async function fetchForgottenAllocatedCandyMachine(
  hash: string,
): Promise<Array<any>> {
  ...
  console.log(candyMachineConfigs);

  return candyMachineConfigs;
}

// console.log(fetchForgottenAllocatedCandyMachine("G17UmNGnMJ851x3M1JXocgpft1afcYedjPuFpo1ohhCk"))
console.log(
  fetchForgottenAllocatedCandyMachine(
    'JE7FqTYGKtcWFqhduHgXRsSPMhWSGBphB1FNvwb188RY',
  ),
);
// JE7FqTYGKtcWFqhduHgXRsSPMhWSGBphB1FNvwb188RY
